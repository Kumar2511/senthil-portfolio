...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        "hero-gradient": "radial-gradient(ellipse 80% 80% at 50% -20%, hsl(var(--primary) / 0.3) 0%, transparent 50%), radial-gradient(ellipse 60% 60% at 80% 50%, hsl(var(--accent) / 0.15) 0%, transparent 40%)",
